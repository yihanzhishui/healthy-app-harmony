...
- `/user/get_lastest_day_sleep_record`
...
- `/user/get_this_week_sleep_record`
...
- `/user/get_diet_record_by_diet_type`
...
- `/user/get_diet_record_by_create_time`
